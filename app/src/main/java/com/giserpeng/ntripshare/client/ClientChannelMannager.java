...
public class ClientChannelMannager {
    ...
    private static  Map<String, Channel> clientChannels = new ConcurrentHashMap<String, Channel>();
    public static void borrowProxyChanel(String ServerIP,int ServerPort,  Bootstrap bootstrap, final ProxyChannelBorrowListener borrowListener) {
