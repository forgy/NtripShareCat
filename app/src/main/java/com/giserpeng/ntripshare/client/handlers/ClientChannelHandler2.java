...
//import com.giserpeng.ntripshare.common.Config;
 ...
 *
 */
public class ClientChannelHandler2 extends SimpleChannelInboundHandler<ProxyMessage> {

    private static Logger logger = LoggerFactory.getLogger(ClientChannelHandler2.class);
    ...
    public ClientChannelHandler2(Bootstrap bootstrap, Bootstrap proxyBootstrap, ChannelStatusListener channelStatusListener) {
